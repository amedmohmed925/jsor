...
const MissionInroad = () => {
    ...
    useEffect(() => {
        ...
        // Get current location for live tracking
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(
                (pos) => {
                    const curLat = pos.coords.latitude;
                    const curLon = pos.coords.longitude;
                    setCurrentLocation([curLat, curLon]);
                    setRemainingDistance(calculateDistance(curLat, curLon, dLat, dLon));
                },
                () => {} // silent fail
            );
        }
                        ...
                        <div className="shadow p-3 rounded-3 h-100">
                            ...
                            <div className="d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <div className="d-flex align-items-center flex-wrap gap-2 mt-3">
                                    ...
                                    <p className="orders-card-title mb-2">{totalDistance} {isRtl ? 'كلم' : 'km'}</p>
                                ...
                                <div className="d-flex gap-2 align-items-center mt-3">
                                    <div className="rest-kms">
                                        {isRtl ? 'باقي' : 'Remaining'} {remainingDistance} {isRtl ? 'كلم' : 'km'}
                                    </div>
                                    <button type='button' className="login-button text-decoration-none" onClick={handleArrived}>
                                        {isRtl ? 'وصلت' : 'Arrived'}
                                    </button>
                                </div>
                            </div>
