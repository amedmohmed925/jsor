        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          ...
          <ul className="navbar-nav align-items-lg-center gap-lg-5">
            ...
            <li className="nav-item d-flex align-items-center gap-2">
                <Link to="/user/notifications" className="nav-labg-mode position-relative">
                ...
                <Link to="/user/profile" className="d-flex gap-2 align-items-center text-decoration-none">
